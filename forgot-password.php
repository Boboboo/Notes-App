...
//If the email does not exist
            //print error message
if($count != 1){
    echo '<div class="alert alert-warning">That email does not exist on our database!</div>';  exit;
}
...
if(mail($email, 'Reset your password', $message, 'From:'.'boofcourse@gmail.com')){   //PHP email的格式：to,subject,text,header
